...
import { NeumeComponentAQ, NeumeComponentSQ, NeumeComponentOH, Syllable, SyllableWord, getNeumeComponentList, toSeptenary } from '../utility/components.js';
...
*/
export function displayRating(certaintyPercentage) {
 ...
 */
export function parseMEIContentToJSON(meiContent) {
    let meiJSON = {};
 ...
 */
export function getNotationType(meiJSON) {
 ...
 */
export function getPEMUrls(meiJSON) {
    let urls = [];
 ...
 */
export function getClefInformation(meiJSON, notationType, modeDescription) {
    let clef = {
        "line": 0,
        "shape": null
    }
 ...
 */
export function getChantTitle(meiJSON) {
 ...
 * @param {JSON} meiJSON 
 */
export function getCantusId(meiJSON) {
 ...
 */
export function getSource(meiJSON) {
    const check = meiJSON.mei.meiHead[0].manifestationList;
    if (check != null){
...
export function getAllSyllables(meiJSON) {
 ...
 */
export function parseToSyllableObject(syllable, notationType) {
 ...
 */
export function parseToSyllableArray(allSyllables, notationType) {
    let syllableArray = [];
...
/**
 * Helper export function to calculate the mode of the Aquitanian chant.
 ...
 */
export function calculateAquitanianMode(syllables) {
    let possibleModes = [];
    let modeDescription = "";
 ...
 */
export function calculateSquareMode(syllables) {
